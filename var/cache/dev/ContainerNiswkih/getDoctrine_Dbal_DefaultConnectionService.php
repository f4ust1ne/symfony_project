...
return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlite', 'host' => NULL, 'port' => NULL, 'dbname' => 'symfony', 'user' => NULL, 'password' => NULL, 'charset' => 'UTF8', 'path' => ($this->targetDirs[2].'/data/data.sqlite'), 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
